    ...
    <>
      ...
      <section className="w-full h-full flex justify-center items-center">
        <form action="#" className="w-[600px] h-[600px] bg-tertiary rounded-2xl p-12 flex flex-col justify-between">
          ...
          <input className="bg-[#d9d9d9] w-full h-14 rounded-2xl pl-4 focus:outline-none focus:ring-4 focus:ring-secundary" type="text" placeholder="User"/>
          <input className="bg-[#d9d9d9] w-full h-14 rounded-2xl pl-4 focus:outline-none focus:ring-4 focus:ring-secundary" type="text" placeholder="Password"/>
